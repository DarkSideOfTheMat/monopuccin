...
local C = require("monopuccin.palettes").get_palette()
...
if ok then
	...
	if require("monopuccin").flavour == "latte" then
		local latte = require("monopuccin.palettes").get_palette "latte"
		sett.text = latte.base
		sett.bkg = latte.crust
	end

	if require("monopuccin").options.transparent_background then sett.bkg = "NONE" end

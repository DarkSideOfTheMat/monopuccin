...
function M.get()
	...
	local hlgroups = {
		...
		SnacksDashboardFooter = { fg = C.green, style = { "italic" } },
		SnacksDashboardHeader = { fg = C.yellow },
		SnacksDashboardIcon = { fg = C.peach, bold = true },
		SnacksDashboardKey = { fg = C.red },
		SnacksDashboardTerminal = { link = "SnacksDashboardNormal" },
		SnacksDashboardSpecial = { fg = C.yellow, style = { "bold" } },
		SnacksDashboardTitle = { fg = C.green },

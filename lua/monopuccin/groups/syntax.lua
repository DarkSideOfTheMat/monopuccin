...
function M.get()
	return {
		...
		Constant = { fg = C.mauve }, -- (preferred) any constant
		String = { fg = C.yellow, style = O.styles.strings or {} }, -- a string constant: "this is a string"
		Character = { fg = C.mauve }, --  a character constant: 'c', '\n'
		Number = { fg = C.mauve, style = O.styles.numbers or {} }, --   a number constant: 234, 0xff
		Float = { link = "Number" }, --    a floating point constant: 2.3e10
		Boolean = { fg = C.mauve, style = O.styles.booleans or {} }, --  a boolean constant: TRUE, false
		...
		Structure = { fg = C.sapphire, style = { "italic" } }, --  struct, union, enum, etc.
		Special = { fg = C.peach }, -- (preferred) any special symbol
		Type = { fg = C.sapphire, style = O.styles.types or {} }, -- (preferred) int, long, char, etc.
		...
		Todo = { fg = C.mauve, style = { "bold" } }, -- (preferred) anything that needs extra attention; mostly the keywords TODO FIXME and XXX
